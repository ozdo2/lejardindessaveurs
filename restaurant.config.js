...
const RESTAURANT_CONFIG = {
    ...
    evenements: [
        {
            ...
            titre: "Soirée Jazz Live",
            description: "Profitez d'une ambiance musicale unique avec nos concerts de jazz en live. Réservation recommandée.",
        },
        {
            icone: "🍷",
            date: "15 Janvier 2025",
            titre: "Dégustation de Vins",
            description: "Soirée dégustation avec notre sommelier. Découvrez nos meilleurs crus accompagnés de mets raffinés.",
        },
        {
            icone: "🎄",
            date: "31 Décembre 2024",
            titre: "Réveillon du Nouvel An",
            description: "Menu spécial 7 services pour célébrer la nouvelle année dans l'élégance. Places limitées.",
        },
        {
            icone: "👨‍🍳",
            date: "20 Février 2025",
            titre: "Atelier Cuisine",
            description: "Apprenez les secrets de notre chef lors d'un atelier exclusif. Nombre de places limité.",
        },
    ],
    ...
    chatbot_reponses: [
        ...
        },
        {
            ...
            reponse: "Pour réserver une table, utilisez notre formulaire sur cette page ou appelez-nous au +33 1 42 34 56 78 ! 📞",
        },
        {
        ...
        },
        {
            ...
            reponse: "Nous sommes situés au 42 Avenue des Gourmets, 75001 Paris. Consultez la carte sur notre page ! 📍",
        },
        {
            mots_cles: ["contact", "téléphone", "email", "appel"],
            reponse: "📞 Téléphone : +33 1 42 34 56 78<br>📧 Email : contact@jardindessaveurs.fr",
        },
        {
    ...
    chatbot_defaut: "Je n'ai pas bien compris votre question. Contactez-nous au +33 1 42 34 56 78 ou par email à contact@jardindessaveurs.fr 😊",
